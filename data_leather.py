...
class dataProcess(object):
    def __init__(self, out_rows, out_cols, train_path="leather/train", train_label="leather/trainannot",
                 val_path="leather/val", val_label="leather/valannot",
                 test_path="leather/test", test_label='leather/testannot', npy_path="./npydata", img_type="png"):
    ...
    def label2class(self, label):
        #print('rows:', self.out_rows)
        #print('cols:', self.out_cols)
    ...
    def create_train_data(self):
        ...
        print('loading done')
        np.save(self.npy_path + '/leather_train.npy', imgdatas)
        np.save(self.npy_path + '/leather_mask_train.npy', imglabels)
    ...
    def create_test_data(self):
        ...
        txtname = './results/leather.txt'
        with open(txtname, 'w') as f:
            for i in range(len(testpathlist)):
                f.writelines(testpathlist[i] + '\n')
        print('loading done')
        np.save(self.npy_path + '/leather_test.npy', imgdatas)
        print('Saving to imgs_test.npy files done.')

    def load_train_data(self):
        print('load train images...')
        imgs_train = np.load(self.npy_path + "/leather_train.npy")
        imgs_mask_train = np.load(self.npy_path + "/leather_mask_train.npy")
    ...
    def load_test_data(self):
        ...
        print('-' * 30)
        imgs_test = np.load(self.npy_path + "/leather_test.npy")
